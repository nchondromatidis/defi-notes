...
<div className='codeBlock'>
$$
amountOut = \frac{reserveOut \cdot 0.997 \cdot amountIn}{reserveIn + 0.997 \cdot amountIn}
$$
</div>
...
<div className='codeBlock'>
  $$
  amountIn = \frac{reserveIn \cdot amountOut}{ 0.997 \cdot (reserveOut - amountOut)}
  $$
</div>
...
This code commits a **token swap** transaction in an EVM node running in-browser.
...
The function tracer decodes the committed transaction in the browser and shows every function executed.
